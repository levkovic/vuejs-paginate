<template>
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    <li v-for="page in pages" :class="[pageClass, page.selected ? activeClass : '', page.disabled ? disabledClass : '', page.breakView ? breakViewClass: '']">
      <a v-if="page.breakView" :class="[pageLinkClass, breakViewLinkClass]" tabindex="0" role="button"><slot name="breakViewContent">{{ breakViewText }}</slot></a>
  ...
  <div :class="containerClass" v-else>
    ...
    <template v-for="page in pages">
      <a v-if="page.breakView" :class="[pageLinkClass, breakViewLinkClass, page.disabled ? disabledClass : '']" tabindex="0" role="button"><slot name="breakViewContent">{{ breakViewText }}</slot></a>
